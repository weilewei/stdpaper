...
<table><tbody>
<tr><th>Doc. no.:</th>    <td>D3060R1</td></tr>
...
The implementation is confirmed to work with clang version 16.0.0+, gcc version 11.1+, and msvc v19.32+: {[<span class="godbolt">&#x2001;</span>Tn1d6h6x9](https://godbolt.org/z/Tn1d6h6x9)|Compiler&puncsp;Explorer}
