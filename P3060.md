...
The implementation is confirmed to work with clang version 16.0.0+, gcc version 11.1+, and msvc v19.32+: {[<span class="godbolt">&#x2001;</span>bM866cb4a](https://godbolt.org/z/bM866cb4a)|Compiler&puncsp;Explorer}
